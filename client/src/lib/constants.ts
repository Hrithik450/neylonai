...
export const messageSets = {
  ...
  resume_build: [
    ...
    "Refining section hierarchy and balance...",
    "Integrating role-relevant phrasing...",
    "Standardizing bullet and layout style...",
    "Adjusting tone to fit job context...",
    "Performing quality assurance on content flow...",
  ],
