...
class ThreadMessageServiceView(APIView):
    ...
    def post(cls, request):
        try:
            ...
            response = ThreadMessageService.create_chat_message(data=validated_data)
    ...
    def get(cls, request, thread_id: str):
        ...
        try:
            ...
            thread_messages_response: ThreadMessagesResponse = (
                ThreadMessageService.list_recent_thread_messages(
            ...
            if thread_messages_response.success:
                thread_messages_data = [
                    tm.model_dump() for tm in thread_messages_response.data
                ]
                return Response(
...
class ThreadMessagesServiceView(APIView):
    ...
    def get(cls, request, thread_id: str):
        ...
        try:
            # Get threads from service
            thread_messages_response: ThreadMessagesResponse = (
                ThreadMessageService.list_thread_messages(thread_id=str(thread_id))
            )
