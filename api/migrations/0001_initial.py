# Generated by Django 5.2.6 on 2026-06-01 06:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(db_column='thread_id', on_delete=django.db.models.deletion.DO_NOTHING, to='api.thread')),
            ],
            options={
