...
class InternalAssistantView(APIView):
    ...
    def post(cls, request):
        try:
            ...
            return Response({"success": False, "error": "Internal server error", "traceback": traceback.format_exc()}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)