...
class LoadInitialAgentConfig:
    ...
    def email_filtering_tool_func(
        ...
        Args:
            ...
            """
        return LoadInitialAgentConfig.email_tool_instance.run_tool(uid, threadId, thread_count, sender, recipient, subject, cc, labels, start_date, end_date, body, html, sort_by, sort_order, limit)
