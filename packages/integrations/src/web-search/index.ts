 ...
 * When enabled, Support Agent may use the web_search tool (Tavily-backed).
...
export const webSearchManifest = {
  ...
  name: "Web Search",
  description:
    "Allow the Support Agent to search the open web for current events and topics outside your knowledge base. Uses the platform search provider when enabled.",
  dataMode: "connect",
  connectable: true,
  planBadge: "starter",
  stubNote:
    "Enable to give Support Agent the web_search tool. Search runs through the platform provider (Tavily).",
