...
export function Footer() {
  ...
  return (
    <footer id="footer" className="px-6 sm:px-10 md:px-20 xl:px-28">
      <div>
        {/* CTA */}
        <div className="text-center py-10 sm:py-14 md:py-16">
          <h2
            ...
            style={{ color: GREEN }}
          >
            Cover support. Capture leads. Skip the hire.
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-8 border-t border-black/[0.08] py-8 sm:py-10 md:py-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-[220px]">
              Automated support and lead capture for small SaaS teams.
            </p>
          </div>
